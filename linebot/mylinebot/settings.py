...
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'mylionbot.settings')
settings.configure()
...
SECRET_KEY = 'django-insecure-_tbet2qd@l)k!7&j^&ip)tg&72p45v$*i7t&v*frwr78(*z$qf'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['67db-210-61-176-1.ngrok-free.app']
...
INSTALLED_APPS = [
    ...
    'foodlinebot.apps.FoodlinebotConfig',  # 加上剛剛所建立的Django應用程式(APP)
]
